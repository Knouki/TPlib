...
use SandraBundle\Form\DeliveryType;
...
class DeliveryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SandraBundle:Delivery')->findAll();
     ...
     * @Method("POST")
     * @Template("SandraBundle:Delivery:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SandraBundle:Delivery')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SandraBundle:Delivery:edit.html.twig")
     */
