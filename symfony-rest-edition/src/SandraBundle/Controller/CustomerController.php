...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SandraBundle:Customer')->findAll();
     ...
     * @Method("POST")
     * @Template("SandraBundle:Customer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SandraBundle:Customer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SandraBundle:Customer:edit.html.twig")
     */
